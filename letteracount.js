...
// Function to find and display amount of 'a' in the text
function amountOfA(declaration) {
    let count = 0;
    for (let i = 0; i < declaration.length; i++) {
        if (declaration[i] === 'a' || declaration[i] === 'A') {
            count++;
        }
    }
    console.log("The amount of 'a' in the text:", count);
}

// Applying the function to count the amount of the letter 'a' in the declaration text
amountOfA(declaration);
